...
export default function TextForm(props) {
    ...
    const handleDeathClick = () => {
        ...
        let newText = text.concat(" Just Go Somewhere And Die!");
        setText(newText);
        props.showAlert("Maa chud gyi ab tumahari !!","dark")
    }
    ...
    return (
        <>
            <div className="container" style={{ color: props.mode === 'dark' ? 'white' : 'black' }}>
                ...
                <button className="btn btn-dark mx-2" onClick={handleDeathClick}>Your Death</button>
            </div>
